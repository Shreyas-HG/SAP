		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#MyCustomerApp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MyCustomerApp-display": {
								"semanticObject": "MyCustomerApp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.customer.mycustomerapp",
									"url": sap.ui.require.toUrl("demo/customer/mycustomerapp")
								}
							}
						}
					}
